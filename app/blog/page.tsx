...
export const metadata: Metadata = {
  title: 'Travel Blog | Azure Horizons Travel',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-12">
              <h2 className="text-2xl font-semibold text-gray-600 mb-2">No Travel Blog Yet</h2>
              <p className="text-gray-500">
                Travel Blog will appear here once content is imported.
              </p>
            </div>
          ) : (

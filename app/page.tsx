...
export async function generateMetadata(): Promise<Metadata> {
  const title = 'Azure Horizons Travel'
  const description = 'Azure Horizons Travel crafts unforgettable journeys to extraordinary destinations around the world.'

  return {
    title,
    description,
    keywords: ["Travel Agency", "Vacation Packages", "Destinations", "Travel Planning", "Adventure Travel", "Luxury Travel"],
    openGraph: {
      title,
      description,
      type: 'website',
